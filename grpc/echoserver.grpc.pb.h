...
#ifndef GRPC_echoserver_2eproto__INCLUDED
#define GRPC_echoserver_2eproto__INCLUDED
  ...
  class WithCallbackMethod_echo : public BaseClass {
   ...
   public:
    WithCallbackMethod_echo() {
      ::grpc::Service::MarkMethodCallback(0,
          new ::grpc::internal::CallbackUnaryHandler< ::EchoRequest, ::EchoResponse>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::EchoRequest* request, ::EchoResponse* response) { return this->echo(context, request, response); }));}
    void SetMessageAllocatorFor_echo(
        ::grpc::MessageAllocator< ::EchoRequest, ::EchoResponse>* allocator) {
    ...
    virtual ::grpc::ServerUnaryReactor* echo(
      ::grpc::CallbackServerContext* /*context*/, const ::EchoRequest* /*request*/, ::EchoResponse* /*response*/)  { return nullptr; }
  };
...
#endif  // GRPC_echoserver_2eproto__INCLUDED
